          ...
          <div className="flex flex-col lg:flex-row h-full">
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div
                  className={`ml-4 space-y-2 text-sm settings-dropdown transform transition-all duration-200 origin-top ${
                    settingsOpen
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-3 rounded-2xl px-3 py-2 text-left hover:bg-gray-100"
                  >
            ...
            <main
              ...
              style={{ color: isDarkMode ? '#e6eef8' : undefined }}
            >
